...
def get_args_parser():
    ...
    parser.add_argument('--mot_path', default='/home/severs-s/kyx_use/pycharm_xinagmu/MOTRv2-main/data/Dataset/mot', type=str)
    ...
    parser.add_argument('--data_txt_path_train',
                        default='/home/severs-s/kyx_use/pycharm_xinagmu/MOTRv2-main/datasets/data_path/mot17.train', type=str,
